...
class MarathonbetDBSearcher extends DBSearcher
{

    /*public function __construct($params = array()) {
        parent::__construct(array_merge($params, MarathonbetRequirement::$config['db_save_rules'] ));
    }*/
    public function findEvent($data)
    {
        ...
        $identity_threshold = MarathonbetRequirement::$config['db_save_rules']['identity_threshold'];
        if(isset($date)) {
            ...
            self::logPush('MarathonbetFootballDBWriter.  No date specified for event M1: '.$member1.' M2: '.$member2.'.', self::$log_filename, self::ERROR);
        }
        return null;
